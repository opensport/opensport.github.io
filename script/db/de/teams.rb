...
teams = [
  ...
  [ 'leverkusen',  'Bayer 04 Leverkusen|Bayer Leverkusen|Bay. Leverkusen', 'B04', 'city:leverkusen' ],
  ...
  [ 'mgladbach',   "Borussia M'gladbach|Bor. M'gladbach|Borussia Mönchengladbach|Mönchengladbach", 'BMG', 'city:mgladbach' ],
