...
####################################################################
# generiert am  2012-10-27 19:15:11 +0200
...
games01 = [
 ...
 [ geo,               [1,0], blr,               Time.utc('2012-09-07 15:00') ], 
 [ fin,               [0,1], fra,               Time.utc('2012-09-07 15:00') ], 
]

games02 = [
 [ aut,               [1,2], ger,               Time.utc('2012-09-11 15:00') ], 
 [ swe,               [2,0], kaz,               Time.utc('2012-09-11 15:00') ], 
 [ geo,               [0,1], esp,               Time.utc('2012-09-11 15:00') ], 
 [ fra,               [3,1], blr,               Time.utc('2012-09-11 15:00') ], 
]
...
games03 = [
 ...
 [ fin,               [1,1], geo,               Time.utc('2012-10-12 17:30') ], 
 [ blr,               [0,4], esp,               Time.utc('2012-10-12 20:00') ], 
]
...
games04 = [
 ...
 [ esp,               [1,1], fra,               Time.utc('2012-10-16 21:00') ], 
 [ blr,               [2,0], geo,               Time.utc('2012-10-16 18:00') ], 
]
...
games05 = [
 ...
 [ fra,               [], geo,               Time.utc('2013-03-22 15:00') ], 
 [ esp,               [], fin,               Time.utc('2013-03-22 15:00') ], 
]

games06 = [
 [ ger,               [], kaz,               Time.utc('2013-03-26 15:00') ], 
 [ irl,               [], aut,               Time.utc('2013-03-26 15:00') ], 
 [ fra,               [], esp,               Time.utc('2013-03-26 15:00') ], 
]

games07 = [
 [ irl,               [], fro,               Time.utc('2013-06-07 15:00') ], 
 [ aut,               [], swe,               Time.utc('2013-06-07 15:00') ], 
 [ fin,               [], blr,               Time.utc('2013-06-07 15:00') ], 
]

games08 = [
 [ swe,               [], fro,               Time.utc('2013-06-11 15:00') ], 
 [ blr,               [], fin,               Time.utc('2013-06-11 15:00') ], 
]
...
games09 = [
 ...
 [ geo,               [], fra,               Time.utc('2013-09-06 15:00') ], 
 [ fin,               [], esp,               Time.utc('2013-09-06 15:00') ], 
]
...
games10 = [
 ...
 [ blr,               [], fra,               Time.utc('2013-09-10 15:00') ], 
 [ geo,               [], fin,               Time.utc('2013-09-10 15:00') ], 
]
...
games11 = [
 ...
 [ esp,               [], blr,               Time.utc('2013-10-11 15:00') ], 
]
...
games12 = [
 ...
 [ fra,               [], fin,               Time.utc('2013-10-15 15:00') ], 
 [ esp,               [], geo,               Time.utc('2013-10-15 15:00') ], 
]
